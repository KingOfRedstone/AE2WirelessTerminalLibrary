...
public class Menus {
    ...
    public static ContainerType<WirelessPatternTerminalContainer> WPT = IForgeContainerType.create((windowId1, inv1, buf1) -> WirelessPatternTerminalContainer.openClient(windowId1, inv1));
    public static ContainerType<WirelessFluidTerminalContainer> WFT = new ContainerType<>(WirelessFluidTerminalContainer::openClient);
    ...
    public static void menus(RegistryEvent.Register<ContainerType<?>> e) {
        ...
        AE2WirelessTerminals.register( "wireless_pattern_terminal", WPT,e.getRegistry());
        AE2WirelessTerminals.register( "wireless_interface_terminal",WIT,e.getRegistry());
        AE2WirelessTerminals.register( "wireless_fluid_terminal", WFT,e.getRegistry());
        ...
        ContainerOpener.addOpener(WPT, (new CheckedOpener(WirelessPatternTerminalContainer::openServer))::open);
        ContainerOpener.addOpener(WIT, (new CheckedOpener(WirelessInterfaceTerminalContainer::openServer))::open);
        ContainerOpener.addOpener(WFT, (new CheckedOpener(WirelessFluidTerminalContainer::openServer))::open);
